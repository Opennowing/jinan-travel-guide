...
export function initA2HS() {
  ...
  window.addEventListener('beforeinstallprompt', (e) => {
    ...
    card.style.cssText = `
      ...
      box-shadow:0 8px 40px rgba(0,0,0,.15),0 0 0 1px rgba(201,169,110,.2);
      padding:20px;animation:a2hsSlideUp .4s ease;
    `;
    ...
    if (!document.getElementById('a2hs-styles')) {
      ...
      style.textContent = `
        ...
        .a2hs-inner{display:flex;align-items:center;gap:14px;flex-wrap:wrap}
        .a2hs-icon{font-size:2rem;flex-shrink:0}
        .a2hs-text{flex:1;min-width:120px}
        .a2hs-text strong{display:block;font-size:.95rem;color:#1a1a1a}
        .a2hs-text span{font-size:.8rem;color:#666}
        .a2hs-install{background:#c9a96e;color:#fff;border:none;padding:10px 24px;border-radius:100px;font-size:.85rem;font-weight:600;cursor:pointer;transition:all .2s;white-space:nowrap}
        .a2hs-install:hover{background:#b8963e}
        .a2hs-dismiss{background:none;border:none;cursor:pointer;font-size:1.1rem;color:#999;padding:4px;position:absolute;top:12px;right:12px;line-height:1}
      `;
